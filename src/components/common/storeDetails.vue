<template>
  <div class="store-details-wrap">
    ...
    ></Header>
    <scroller lock-x height="-4" @on-scroll-bottom="onScrollBottom" ref="scrollerBottom" :scroll-bottom-offst="-8">
      ...
      <div class="contact-address-wrap">
        <div class="contact">
          ...
          <div class="contact-right">
            <a :href="'tel:'+ this.storeDetails.phone"><i class="el-icon-phone-outline"></i></a></div>
          </div>
          ...
          <li>
            <div class="row-one">
              ...
              <div class="point-time">
                ...
                <div class="time">{{this.commentList.data}}</div>
              </div>
            </div>
            <div class="row-two">
...
import { Scroller ,Rater,LoadMore} from 'vux';
export default {
  data() {
    return {
      //获取到的商家id
  ...
  mounted(){
    ...
    .then(({data})=>{
      console.log(data)
      this.commentList = data.data.comment[0]
      console.log(this.commentList)
      //获取用户评分
      this.value2 =  parseInt(data.data.comment[0].score)
